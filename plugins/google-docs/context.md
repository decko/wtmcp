...
- `output_path` (optional): Custom output path (default: `wtmcp/google-docs/<title>.txt`)
...
- `document_id_or_url` (required): Document ID or URL
- `save_to_file` (default: false): Save to local file
- `output_path` (optional): Custom output path (default: `wtmcp/google-docs/<title>.md`)
...
- Default directory: `wtmcp/google-docs/` under the session directory
