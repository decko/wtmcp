...
- `output_path` (optional): Custom output path (default: `.wtmcp-data/google-docs/<title>.txt`)
...
- `document_id_or_url` (required): Document ID or URL
- `save_to_file` (default: false): Save to local file
- `output_path` (optional): Custom output path (default: `.wtmcp-data/google-docs/<title>.md`)
...
- Default directory: `.wtmcp-data/google-docs/` under the session directory
